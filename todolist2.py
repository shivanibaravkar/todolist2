...
if __name__ == "__main__":  
    ...
    header_frame = tk.Frame(guiWindow, bg = "#B22222")  
    functions_frame = tk.Frame(guiWindow, bg = "#B22222")  
    listbox_frame = tk.Frame(guiWindow, bg = "#B22222")  
